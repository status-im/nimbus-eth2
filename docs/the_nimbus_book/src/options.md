...
The following options are available:
 ...
 -d, --data-dir                The directory where nimbus will store all blockchain data.
     ...
     --web3-signer             Remote Web3Signer URL that will be used as a source of validators.
     --web3-signer-update-interval  Number of seconds between validator list updates [=60].
