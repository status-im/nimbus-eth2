...
1. Navigate to either `build/data/shared_mainnet_0/db/` (if you're running Hoodi: `shared_hoodi_0`) or the directory you supplied to the `--data-dir` argument when you launched Nimbus.
