...
const
  ...
  AgAttestationElectra =
    "{\"data\":{\"aggregation_bits\":\"0x01\",\"committee_bits\":\"0x0000000000000001\",\"signature\":\"0x1b66ac1fb663c9bc59509846d6ec05345bd908eda73e670af888da41af171505cc411d61252fb6cb3fa0017b679f8bb2305b26a285fa2737f175668d0dff91cc1b66ac1fb663c9bc59509846d6ec05345bd908eda73e670af888da41af171505\",\"data\":{\"slot\":\"1\",\"index\":\"1\",\"beacon_block_root\":\"0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2\",\"source\":{\"epoch\":\"1\",\"root\":\"0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2\"},\"target\":{\"epoch\":\"1\",\"root\":\"0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2\"}}}}"
...
func init(
  ...
  of ConsensusFork.Electra:
    Web3SignerForkedBeaconBlock(
      kind: ConsensusFork.Electra, data: forked.electraData.toBeaconBlockHeader
    )
  of ConsensusFork.Fulu:
    Web3SignerForkedBeaconBlock(
      kind: ConsensusFork.Fulu, data: forked.fuluData.toBeaconBlockHeader
    )
  of ConsensusFork.Gloas:
    Web3SignerForkedBeaconBlock(
      kind: ConsensusFork.Gloas, data: forked.gloasData.toBeaconBlockHeader
    )
...
block:
  ...
  suite "Nimbus remote signer/signing test (web3signer)":
    ...
    asyncTest "Signing aggregate and proof " & "(getAggregateAndProofSignature(phase0))":
      let
    ...
    asyncTest "Signing aggregate and proof " & "(getAggregateAndProofSignature(electra))":
      let
        contentType = ContentTypeData(mediaType: MediaType.init("application/json"))
        agAttestation = decodeBytes(
            GetElectraAggregatedAttestationResponse,
            AgAttestationElectra.toOpenArrayByte(0, len(AgAttestationElectra) - 1),
            Opt.some(contentType),
          )
          .tryGet().data
    ...
    asyncTest "Signing BeaconBlock (getBlockSignature(electra))":
      let
        ...
        sres1 = await validator1.getBlockSignature(
          SigningFork, GenesisValidatorsRoot, blockRoot, forked
        )
    ...
    asyncTest "Signing payload attestation message (getPayloadAttestationSignature())":
      let
        ...
        sres1 = await validator1.getPayloadAttestationSignature(
          SigningFork, GenesisValidatorsRoot, payloadMessage
        )
        sres2 = await validator2.getPayloadAttestationSignature(
          SigningFork, GenesisValidatorsRoot, payloadMessage
        )
        sres3 = await validator3.getPayloadAttestationSignature(
          SigningFork, GenesisValidatorsRoot, payloadMessage
        )
  ...
  suite "Nimbus remote signer/signing test (verifying-web3signer)":
    ...
    asyncTest "Signing BeaconBlock (getBlockSignature(electra))":
      ...
      let
        client = rclient.get()
        sres1 = await validator1.getBlockSignature(
          SigningFork, GenesisValidatorsRoot, blockRoot1, forked1
        )
        sres2 = await validator2.getBlockSignature(
          SigningFork, GenesisValidatorsRoot, blockRoot1, forked1
        )
        ...
        bres1 = await validator4.getBlockSignature(
          SigningFork, GenesisValidatorsRoot, blockRoot2, forked2
        )
