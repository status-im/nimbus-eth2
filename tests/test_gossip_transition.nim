...
suite "Gossip fork transition":
  test "Gossip fork transition":
    check:
      ...
      getTargetGossipState(10, 0, 5, 8, 11, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(5, 0, 2, 3, 6, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(2, 2, 6, 8, 11, false) == {ConsensusFork.Altair}
      getTargetGossipState(10, 0, 6, 8, 11, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(5, 2, 6, 8, 10, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(0, 1, 2, 8, 9, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      getTargetGossipState(6, 2, 7, 8, 11, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(2, 3, 4, 6, 7, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(0, 1, 5, 7, 9, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(7, 2, 3, 7, 8, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(3, 2, 4, 5, 11, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(0, 1, 2, 3, 7, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      getTargetGossipState(11, 2, 4, 5, 8, false) == {ConsensusFork.Deneb}
      getTargetGossipState(6, 1, 5, 7, 9, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(10, 0, 2, 4, 11, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(1, 0, 2, 7, 11, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(6, 1, 2, 5, 7, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(7, 2, 7, 8, 9, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(7, 0, 1, 2, 8, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(7, 0, 1, 8, 9, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(3, 1, 7, 9, 10, false) == {ConsensusFork.Altair}
      getTargetGossipState(6, 2, 6, 7, 11, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(2, 3, 5, 7, 10, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      getTargetGossipState(10, 4, 5, 7, 9, false) == {ConsensusFork.Deneb}
      getTargetGossipState(8, 1, 4, 5, 8, false) == {ConsensusFork.Deneb}
      getTargetGossipState(9, 0, 2, 7, 10, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(8, 1, 5, 7, 8, false) == {ConsensusFork.Deneb}
      getTargetGossipState(8, 1, 3, 7, 9, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(4, 0, 3, 4, 11, false) == {ConsensusFork.Capella}
      getTargetGossipState(0, 1, 5, 9, 10, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      getTargetGossipState(3, 4, 6, 7, 8, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(0, 0, 1, 3, 4, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(3, 4, 5, 7, 9, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      getTargetGossipState(10, 3, 6, 8, 9, true) == {}
      getTargetGossipState(6, 7, 9, 10, 11, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(10, 0, 5, 7, 11, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(10, 3, 5, 7, 11, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(8, 5, 7, 8, 9, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(10, 1, 5, 6, 11, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(5, 0, 0, 1, 4, false) == {ConsensusFork.Deneb}
      getTargetGossipState(8, 0, 2, 5, 7, false) == {ConsensusFork.Deneb}
      getTargetGossipState(7, 3, 4, 8, 10, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(9, 1, 6, 9, 10, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(2, 0, 1, 3, 11, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(8, 1, 3, 6, 9, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(1, 1, 2, 8, 9, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(6, 4, 7, 9, 10, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(4, 1, 2, 5, 6, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(9, 0, 6, 9, 10, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(0, 0, 1, 5, 7, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(2, 1, 3, 8, 10, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(2, 0, 3, 4, 7, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(1, 2, 3, 8, 10, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(0, 1, 2, 3, 11, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(7, 2, 6, 8, 10, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(10, 2, 6, 7, 11, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(2, 2, 3, 5, 7, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(9, 0, 4, 10, 11, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(4, 1, 5, 7, 11, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(0, 1, 2, 3, 6, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      getTargetGossipState(0, 3, 4, 5, 9, false) == {ConsensusFork.Phase0}
      getTargetGossipState(5, 3, 6, 7, 9, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(2, 0, 2, 3, 5, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(1, 1, 2, 7, 8, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(5, 0, 1, 2, 8, false) == {ConsensusFork.Capella}
      getTargetGossipState(5, 3, 6, 9, 11, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(4, 4, 5, 9, 10, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(1, 1, 5, 6, 7, false) == {ConsensusFork.Altair}
      getTargetGossipState(3, 0, 0, 4, 8, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(3, 0, 0, 1, 4, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(2, 3, 4, 9, 11, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(5, 2, 6, 8, 9, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(5, 1, 3, 6, 10, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(1, 0, 1, 2, 7, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(0, 0, 5, 6, 8, false) == {ConsensusFork.Altair}
      getTargetGossipState(9, 2, 4, 5, 8, true) == {}
      getTargetGossipState(1, 0, 0, 2, 10, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(2, 1, 3, 10, 11, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(4, 0, 5, 7, 11, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(8, 2, 3, 7, 8, true) == {}
      getTargetGossipState(8, 2, 4, 7, 9, true) == {}
      getTargetGossipState(10, 4, 5, 6, 8, true) == {}
      getTargetGossipState(1, 1, 2, 8, 10, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(0, 1, 4, 8, 10, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(3, 4, 8, 10, 11, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(9, 0, 5, 8, 10, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(2, 2, 3, 9, 11, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      getTargetGossipState(3, 2, 6, 8, 9, false) == {ConsensusFork.Altair}
      getTargetGossipState(7, 0, 7, 8, 9, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(7, 0, 5, 6, 8, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(9, 1, 9, 10, 11, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(0, 1, 2, 3, 4, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(6, 0, 2, 7, 8, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      getTargetGossipState(0, 1, 6, 7, 9, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(3, 0, 4, 8, 10, false) ==
        {ConsensusFork.Altair, ConsensusFork.Bellatrix}
      ...
      getTargetGossipState(10, 1, 3, 7, 11, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      getTargetGossipState(3, 2, 5, 6, 7, false) == {ConsensusFork.Altair}
      getTargetGossipState(9, 4, 9, 10, 11, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(7, 0, 1, 7, 8, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
      ...
      getTargetGossipState(6, 1, 6, 7, 11, false) ==
        {ConsensusFork.Bellatrix, ConsensusFork.Capella}
      ...
      getTargetGossipState(1, 2, 5, 9, 10, false) ==
        {ConsensusFork.Phase0, ConsensusFork.Altair}
      ...
      getTargetGossipState(4, 1, 2, 3, 5, false) ==
        {ConsensusFork.Capella, ConsensusFork.Deneb}
