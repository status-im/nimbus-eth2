  ...
  test "validateAttestation":
    ...
    check:
      ...
      validateAttestation(
        ...
        batchCrypto,
        att_1_0,
        beaconTime - cfg.timeParams.SLOT_DURATION * SLOTS_PER_EPOCH.int64 - 1.seconds,
        subnet,
        true,
      )
        .waitFor().isErr
    ...
    block:
      ...
      let
        fut_1_0 =
          validateAttestation(pool, batchCrypto, broken_1_0, beaconTime, subnet, true)
        fut_1_1 =
          validateAttestation(pool, batchCrypto, broken_1_1, beaconTime, subnet, true)
    ...
    proc checkWithSignatureSlot(signatureSlot: Slot, expectValid: bool) =
      ...
      let
        ...
        msgVerdict = waitFor noCancel dag.validateSyncCommitteeMessage(
          ...
          msg,
          subcommitteeIdx,
          slot.start_beacon_time(cfg.timeParams),
          checkSignature = true,
        )
