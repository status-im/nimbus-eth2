...
suite "SyncManager test suite":
  for kind in [SyncQueueKind.Forward, SyncQueueKind.Backward]:
    asyncTest "[SyncQueue# & " & $kind & "] Smoke [single peer] test":
      ...
      let
        f1 = sq.push(r1, d1, Opt.none(seq[ForkedBlobSidecars]))
        f2 = sq.push(r2, d2, Opt.none(seq[ForkedBlobSidecars]))
        f3 = sq.push(r3, d3, Opt.none(seq[ForkedBlobSidecars]))
      ...
      let
        ...
        f4 = sq.push(r4, d4, Opt.none(seq[ForkedBlobSidecars]))
    ...
    asyncTest "[SyncQueue# & " & $kind & "] Smoke [3 peers] test":
      ...
      let
        f11 = sq.push(r11, d11, Opt.none(seq[ForkedBlobSidecars]))
        f12 = sq.push(r12, d12, Opt.none(seq[ForkedBlobSidecars]))
        f13 = sq.push(r13, d13, Opt.none(seq[ForkedBlobSidecars]))

        f22 = sq.push(r22, d22, Opt.none(seq[ForkedBlobSidecars]))
        f21 = sq.push(r21, d21, Opt.none(seq[ForkedBlobSidecars]))
        f23 = sq.push(r23, d23, Opt.none(seq[ForkedBlobSidecars]))

        f33 = sq.push(r33, d33, Opt.none(seq[ForkedBlobSidecars]))
        f32 = sq.push(r32, d32, Opt.none(seq[ForkedBlobSidecars]))
        f31 = sq.push(r31, d31, Opt.none(seq[ForkedBlobSidecars]))
      ...
      await noCancel sq.push(r41, d41, Opt.none(seq[ForkedBlobSidecars]))
    ...
    asyncTest "[SyncQueue# & " & $kind & "] Failure request push test":
      ...
      block:
        ...
        sq.push(r11)
        await noCancel sq.push(r12, d12, Opt.none(seq[ForkedBlobSidecars]))
        sq.push(r13)
        # Next couple of calls should be detected as non relevant
        sq.push(r11)
        sq.push(r12)
      ...
      block:
        ...
        sq.push(r11)
        sq.push(r12)
        await noCancel sq.push(r13, d13, Opt.none(seq[ForkedBlobSidecars]))
        # Next couple of calls should be detected as non relevant
        sq.push(r11)
        sq.push(r12)
        sq.push(r13)
    ...
    asyncTest "[SyncQueue# & " & $kind & "] Invalid block [3 peers] test":
      ...
      let
        ...
        f32 = sq.push(r32, d32, Opt.none(seq[ForkedBlobSidecars]))
        f33 = sq.push(r33, d33, Opt.none(seq[ForkedBlobSidecars]))
        f42 = sq.push(r42, d42, Opt.none(seq[ForkedBlobSidecars]))
        f41 = sq.push(r41, d41, Opt.none(seq[ForkedBlobSidecars]))
        f43 = sq.push(r43, d43, Opt.none(seq[ForkedBlobSidecars]))
    ...
    asyncTest "[SyncQueue# & " & $kind & "] Combination of missing parent " &
      ...
      let
        ...
        d42 = createChain(r42.data)
        d43 = createChain(r43.data)
        f42 = sq.push(r32, d42, Opt.none(seq[ForkedBlobSidecars]))
        f41 = sq.push(r31, d41, Opt.none(seq[ForkedBlobSidecars]))
        f43 = sq.push(r33, d43, Opt.none(seq[ForkedBlobSidecars]))
  ...
  asyncTest "[SyncQueue#Forward] Missing parent and exponential rewind " &
    ...
    for i in 0 ..< 3:
      let
        ...
        fe1 = sq.push(re1, de1, Opt.none(seq[ForkedBlobSidecars]))
        fe2 = sq.push(re2, de2, Opt.none(seq[ForkedBlobSidecars]))
        fe3 = sq.push(re3, de3, Opt.none(seq[ForkedBlobSidecars]))
    ...
    for i in 0 ..< 5:
      let
        ...
        ff1 = sq.push(rf1, df1, Opt.none(seq[ForkedBlobSidecars]))
        ff2 = sq.push(rf2, df2, Opt.none(seq[ForkedBlobSidecars]))
        ff3 = sq.push(rf3, df3, Opt.none(seq[ForkedBlobSidecars]))
  ...
  asyncTest "[SyncQueue#Backward] Missing parent and exponential rewind " &
    ...
    for i in 0 ..< 3:
      let
        ...
        f51 = sq.push(r51, d51, Opt.none(seq[ForkedBlobSidecars]))
        f52 = sq.push(r52, d52, Opt.none(seq[ForkedBlobSidecars]))
        f53 = sq.push(r53, d53, Opt.none(seq[ForkedBlobSidecars]))
    ...
    let
      ...
      f61 = sq.push(r61, d61, Opt.none(seq[ForkedBlobSidecars]))
      f62 = sq.push(r62, d62, Opt.none(seq[ForkedBlobSidecars]))
      f63 = sq.push(r63, d63, Opt.none(seq[ForkedBlobSidecars]))
    ...
    for i in 0 ..< 5:
      let
        ...
        f71 = sq.push(r71, d71, Opt.none(seq[ForkedBlobSidecars]))
        f72 = sq.push(r72, d72, Opt.none(seq[ForkedBlobSidecars]))
        f73 = sq.push(r73, d73, Opt.none(seq[ForkedBlobSidecars]))
