...
suite "Remove keystore testing suite":
  test "vesion 1":
    for version in [1, 2]:
      ...
      check keystore.pubkey.toHex ==
        "8b9c875fbe539c6429c4fc304675062579ce47fb6b2ac6b6a1ba1188ca123a80affbfe381dbbc8e7f2437709a4c3325c"
      check keystore.remotes.len == 1
      check $keystore.remotes[0].url == "http://127.0.0.1:6000"
      check keystore.remotes[0].id == 0
      check keystore.remotes[0].pubkey.toHex ==
        "8b9c875fbe539c6429c4fc304675062579ce47fb6b2ac6b6a1ba1188ca123a80affbfe381dbbc8e7f2437709a4c3325c"
  ...
  test "Many remotes":
    for version in [2, 3]:
      ...
      let keystore = parse(remoteKeyStores)
      check keystore.pubkey.toHex ==
        "8ebc7291df2a671326de83471a4feeb759cc842caa59aa92065e3508baa7e50513bc49a79ff4387c8ef747764f364b6f"
      ...
      check keystore.remotes[1].pubkey.toHex ==
        "8b8c115d19a9bdacfc7af9c8e8fc1353af54b63b0e772a641499cac9b6ea5cb1b3479cfa52ebc98ba5afe07a06c06238"
      check keystore.remotes[2].pubkey.toHex ==
        "8f5f9e305e7fcbde94182747f5ecec573d1786e8320a920347a74c0ff5e70f12ca22607c98fdc8dbe71161db59e0ac9d"
  ...
  test "Verifying Signer / Single remote":
    for version in [3]:
      ...
      check keystore.provenBlockProperties[0].bellatrixIndex ==
        some GeneralizedIndex(401)
