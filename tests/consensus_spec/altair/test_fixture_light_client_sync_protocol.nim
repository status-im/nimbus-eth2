...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/tests/core/pyspec/eth2spec/test/helpers/sync_committee.py#L27-L44
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/tests/core/pyspec/eth2spec/test/helpers/light_client.py#L11-L41
