...
proc runTest(storeDataFork: static LightClientDataFork) =
  suite "EF - " & $storeDataFork &
    ...
    # https://github.com/ethereum/consensus-specs/blob/v1.6.0-alpha.0/tests/core/pyspec/eth2spec/test/altair/unittests/light_client/test_sync_protocol.py#L64-L96
