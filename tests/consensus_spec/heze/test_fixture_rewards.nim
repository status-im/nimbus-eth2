...
import
  ...
  ../../../beacon_chain/spec/datatypes/[altair, heze],
  # Test utilities
  ../../testutil,
  ../fixtures_utils, ../os_ops

const
  RewardsDirBase = SszTestsDir/const_preset/"heze"/"rewards"
...
suite "EF - Heze - Rewards " & preset():
  for rewardsDir in [RewardsDirBasic, RewardsDirLeak, RewardsDirRandom]:
    for kind, path in walkDir(rewardsDir, relative = true, checkDir = true):
      test "EF - Heze - Rewards - " & path & preset():
