...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/tests/core/pyspec/eth2spec/test/helpers/keys.py
...
func makeAttestationData*(
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/phase0/validator.md#attestation-data
  AttestationData(
    slot: slot,
