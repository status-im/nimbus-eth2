 ...
 *
 * @see https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/configs/README.md
 */
ETH_RESULT_USE_CHECK
 ...
 * @see https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/altair/beacon-chain.md#beaconstate
 * @see https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/bellatrix/beacon-chain.md#beaconstate
 ...
 *
 * @see https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/phase0/beacon-chain.md#custom-types
 */
ETH_RESULT_USE_CHECK
 ...
 * @see https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/altair/light-client/light-client.md
 * @see https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/phase0/weak-subjectivity.md#weak-subjectivity-period
 */
ETH_RESULT_USE_CHECK
 ...
 *
 * @see https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/phase0/beacon-chain.md#hash_tree_root
 */
ETH_RESULT_USE_CHECK
 ...
 *
 * @see https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/phase0/beacon-chain.md#beaconblockheader
 */
ETH_RESULT_USE_CHECK
