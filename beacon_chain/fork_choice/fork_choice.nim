...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/specs/phase0/fork-choice.md#should_update_justified_checkpoint
...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/specs/phase0/fork-choice.md#on_block
...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/specs/phase0/fork-choice.md#on_tick
proc on_tick(
...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/specs/phase0/fork-choice.md#on_attester_slashing
...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/fork_choice/safe-block.md#get_safe_beacon_block_root
