...
proc new*(
  ...
  when declared(waitSignal):
    ValidatorClientRef(
      ...
      attesterDutiesInvalidationEvent: newAsyncEvent(),
      proposerDutiesInvalidationEvent: newAsyncEvent(),
      syncDutiesInvalidationEvent: newAsyncEvent(),
      ptcDutiesInvalidationEvent: newAsyncEvent(),
