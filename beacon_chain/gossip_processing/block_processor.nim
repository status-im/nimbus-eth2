...
proc storeBlock(
  ...
  if NewPayloadStatus.noResponse == payloadStatus:
    ...
    # https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/bellatrix/beacon-chain.md#verify_and_notify_new_payload
    # https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/specs/deneb/beacon-chain.md#modified-verify_and_notify_new_payload
    when typeof(signedBlock).kind >= ConsensusFork.Bellatrix:
...
proc processBlock(
  ...
  if res.isErr and res.error[1] == ProcessingStatus.notCompleted:
    ...
    # https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.7/sync/optimistic.md#execution-engine-errors
