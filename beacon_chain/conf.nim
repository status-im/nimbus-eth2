...
type
  ...
  BeaconNodeConf* = object
    ...
    of BNStartUpCmd.noCommand:
      ...
      custodySubnetCount* {.
        desc: "Number of custody subnets the BN wants to be subscribed to" &
              "Must be in the range: Custody Requirement to Max Data Column Subnet Count"
        name: "custodySubnetCount" .}: Option[uint64]
