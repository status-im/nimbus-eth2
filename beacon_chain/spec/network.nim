...
const
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/p2p-interface.md#topics-and-messages
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/altair/light-client/p2p-interface.md#configuration
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/altair/p2p-interface.md#topics-and-messages
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/altair/p2p-interface.md#transitioning-the-gossip
...
func nearSyncCommitteePeriod*(epoch: Epoch): Opt[uint64] =
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/altair/validator.md#sync-committee-subnet-stability
...
func getSyncSubnets*(
  ...
  for i, pubkey in syncCommittee.pubkeys:
    ...
    # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/altair/validator.md#broadcast-sync-committee-message
