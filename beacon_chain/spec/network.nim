...
const
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/specs/capella/p2p-interface.md#topics-and-messages
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/specs/bellatrix/p2p-interface.md#configuration
...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/specs/phase0/validator.md#broadcast-attestation
...
func getSyncSubnets*(
  ...
  for i, pubkey in syncCommittee.pubkeys:
    ...
    # https://github.com/ethereum/consensus-specs/blob/v1.3.0-alpha.2/specs/altair/validator.md#broadcast-sync-committee-message
