...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/phase0/weak-subjectivity.md#configuration
const SAFETY_DECAY* = 10'u64

# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/phase0/weak-subjectivity.md#compute_weak_subjectivity_period
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/phase0/weak-subjectivity.md#is_within_weak_subjectivity_period
