...
const
  ...
  BLS_MODULUS* =
    "52435875175126190479447740508185965837690552500527637822603658699938581184513".u256
...
type
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.6.0-alpha.0/specs/phase0/beacon-chain.md#beaconblock
  BeaconBlock* = object
...
func kzg_commitment_inclusion_proof_gindex*(index: BlobIndex): GeneralizedIndex =
  ...
  const
    ...
    BLOB_KZG_COMMITMENTS_GINDEX = 27.GeneralizedIndex
    # List + 0 = items, + 1 = len
    BLOB_KZG_COMMITMENTS_BASE_GINDEX = (BLOB_KZG_COMMITMENTS_GINDEX shl 1) + 0
    # List depth
...
# https://github.com/ethereum/consensus-specs/blob/v1.5.0-beta.0/specs/deneb/light-client/sync-protocol.md#modified-get_lc_execution_root
...
func upgrade_lc_header_to_deneb*(pre: capella.LightClientHeader): LightClientHeader =
  LightClientHeader(
    beacon: pre.beacon,
    execution: ExecutionPayloadHeader(
...
# https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.3/specs/deneb/light-client/fork.md#upgrading-light-client-data
func upgrade_lc_update_to_deneb*(pre: capella.LightClientUpdate): LightClientUpdate =
  LightClientUpdate(
...
# https://github.com/ethereum/consensus-specs/blob/v1.5.0-beta.4/specs/deneb/light-client/fork.md#upgrading-light-client-data
...
func upgrade_lc_store_to_deneb*(pre: capella.LightClientStore): LightClientStore =
