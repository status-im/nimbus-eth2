...
const
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/light-client/sync-protocol.md#constants
...
type
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/beacon-chain.md#withdrawal
  Withdrawal* = object
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/capella/beacon-chain.md#blstoexecutionchange
  BLSToExecutionChange* = object
    validator_index*: uint64
    from_bls_pubkey*: ValidatorPubKey
    to_execution_address*: ExecutionAddress

  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/beacon-chain.md#signedblstoexecutionchange
  SignedBLSToExecutionChange* = object
    message*: BLSToExecutionChange
    signature*: ValidatorSig

  # https://github.com/ethereum/consensus-specs/blob/v1.3.0/specs/capella/beacon-chain.md#historicalsummary
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/beacon-chain.md#executionpayload
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/beacon-chain.md#executionpayloadheader
  ...
  # https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/light-client/sync-protocol.md#modified-lightclientheader
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/light-client/sync-protocol.md#get_lc_execution_root
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/light-client/sync-protocol.md#modified-is_valid_light_client_header
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/light-client/fork.md#upgrading-light-client-data
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/light-client/fork.md#upgrading-the-store
