...
from ./electra import 
  PendingBalanceDeposit, PendingPartialWithdrawal, 
...
type
  ...
  # https://github.com/ethereum/consensus-specs/blob/1508f51b80df5488a515bfedf486f98435200e02/specs/_features/eip7732/beacon-chain.md#modified-containers
...
func shortLog*(v: PayloadAttestation): auto =
  (
...
func shortLog*(v: PayloadAttestationMessage): auto =
  (
    validatorIndex: shortLog(v.validatorIndex),
    data: shortLog(v.data),
    signature: shortLog(v.signature)
  )

func shortLog*(v: IndexedPayloadAttestation): auto =
  (
    attestingIndices: shortLog(v.attestingIndices),
    data: shortLog(v.data),
    signature: shortLog(v.signature)
  )
