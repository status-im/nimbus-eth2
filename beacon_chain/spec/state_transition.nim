...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-rc.0/specs/phase0/beacon-chain.md#beacon-chain-state-transition-function
#
...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-rc.0/specs/phase0/validator.md#preparing-for-a-beaconblock
...
# https://github.com/ethereum/consensus-specs/blob/v1.3.0-rc.0/specs/altair/validator.md#preparing-a-beaconblock
template partialBeaconBlock*(
    cfg: RuntimeConfig,
