...
proc process_execution_payload*(
  ...
  if committed_bid.prev_randao != payload.prev_randao:
...
# https://github.com/ethereum/consensus-specs/blob/v1.6.1/specs/gloas/beacon-chain.md#new-process_execution_payload_bid
proc process_execution_payload_bid*(
  ...
  if bid.prev_randao != get_randao_mix(state, epoch):
    return err("process_execution_payload_bid: prev randao mismatch")
