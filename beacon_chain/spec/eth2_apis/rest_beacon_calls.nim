...
proc getStateFork*(
  state_id: StateIdent
): RestResponse[GetStateForkResponse] {.
...
): RestPlainResponse {.rest, endpoint: "/eth/v1/beacon/blocks", meth: MethodPost.}
...
proc publishBlockV2*(
  ...
  let
    ...
    resp = await client.publishBlockV2Plain(
      blck,
      extraHeaders =
        @[("eth-consensus-version", consensus), ("broadcast_validation", "gossip")],
    )
  return resp
...
proc getBlockRoot*(
  block_id: BlockIdent
): RestResponse[GetBlockRootResponse] {.
...
proc getBlockAttestations*(
  block_id: BlockIdent
): RestResponse[GetBlockAttestationsResponse] {.
  rest, endpoint: "/eth/v1/beacon/blocks/{block_id}/attestations", meth: MethodGet
...
proc getPoolAttestations*(
  ...
  rest, endpoint: "/eth/v1/beacon/pool/attestations", meth: MethodGet
.} ## https://ethereum.github.io/beacon-APIs/#/Beacon/getPoolAttestations

proc submitPoolAttestations*(
  body: seq[Attestation]
): RestPlainResponse {.
  rest, endpoint: "/eth/v1/beacon/pool/attestations", meth: MethodPost
...
proc getPoolAttesterSlashings*(): RestResponse[GetPoolAttesterSlashingsResponse] {.
  rest, endpoint: "/eth/v1/beacon/pool/attester_slashings", meth: MethodGet
...
proc submitPoolAttesterSlashings*(
  ...
  rest, endpoint: "/eth/v1/beacon/pool/attester_slashings", meth: MethodPost
...
proc getDepositSnapshot*(): RestResponse[GetDepositSnapshotResponse] {.
  rest, endpoint: "/eth/v1/beacon/deposit_snapshot", meth: MethodGet
