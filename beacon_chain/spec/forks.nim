...
export
  extras, block_id, phase0, altair, bellatrix, capella, deneb, eth2_merkleization,
  eth2_ssz_serialization, forks_light_client, presets, capella_mev, deneb_mev
...
type
  ...
  ForkyBeaconBlockBody* =
    ...
    capella.BeaconBlockBody | deneb.BeaconBlockBody
  ...
  ForkyTrustedBeaconBlock* =
    ...
    capella.TrustedBeaconBlock | deneb.TrustedBeaconBlock
  ...
  ForkyMsgTrustedSignedBeaconBlock* =
    phase0.MsgTrustedSignedBeaconBlock | altair.MsgTrustedSignedBeaconBlock |
    bellatrix.MsgTrustedSignedBeaconBlock | capella.MsgTrustedSignedBeaconBlock |
  ...
  SomeForkySignedBeaconBlock* =
    ...
    ForkyMsgTrustedSignedBeaconBlock | ForkyTrustedSignedBeaconBlock
...
template kind*(
    x: typedesc[
      phase0.BeaconState | phase0.HashedBeaconState | phase0.BeaconBlock |
        ...
        phase0.SigVerifiedSignedBeaconBlock | phase0.MsgTrustedSignedBeaconBlock |
...
template kind*(
    x: typedesc[
      altair.BeaconState | altair.HashedBeaconState | altair.BeaconBlock |
        ...
        altair.SigVerifiedSignedBeaconBlock | altair.MsgTrustedSignedBeaconBlock |
...
template kind*(
    x: typedesc[
      bellatrix.BeaconState | bellatrix.HashedBeaconState | bellatrix.ExecutionPayload |
        bellatrix.ExecutionPayloadForSigning | bellatrix.ExecutionPayloadHeader |
        bellatrix.BeaconBlock | bellatrix.SignedBeaconBlock |
        bellatrix.TrustedBeaconBlock | bellatrix.BeaconBlockBody |
        bellatrix.SigVerifiedBeaconBlockBody | bellatrix.TrustedBeaconBlockBody |
        bellatrix.SigVerifiedSignedBeaconBlock | bellatrix.MsgTrustedSignedBeaconBlock |
...
template kind*(
    x: typedesc[
      capella.BeaconState | capella.HashedBeaconState | capella.ExecutionPayload |
        capella.ExecutionPayloadForSigning | capella.ExecutionPayloadHeader |
        capella.BeaconBlock | capella.SignedBeaconBlock | capella.TrustedBeaconBlock |
        capella.BeaconBlockBody | capella.SigVerifiedBeaconBlockBody |
        capella.TrustedBeaconBlockBody | capella.SigVerifiedSignedBeaconBlock |
        capella.MsgTrustedSignedBeaconBlock | capella.TrustedSignedBeaconBlock |
        capella_mev.SignedBlindedBeaconBlock
    ]
): ConsensusFork =
...
template kind*(
    x: typedesc[
      deneb.BeaconState | deneb.HashedBeaconState | deneb.ExecutionPayload |
        deneb.ExecutionPayloadForSigning | deneb.ExecutionPayloadHeader |
        ...
        deneb.MsgTrustedSignedBeaconBlock | deneb.TrustedSignedBeaconBlock |
...
template BlockContents*(kind: static ConsensusFork): auto =
  when kind == ConsensusFork.Deneb:
...
template PayloadAttributes*(kind: static ConsensusFork): auto =
...
template init*(
    T: type ForkedTrustedBeaconBlock, blck: bellatrix.TrustedBeaconBlock
): T =
  T(kind: ConsensusFork.Bellatrix, bellatrixData: blck)
  ...
  of ConsensusFork.Capella:
    T(
      ...
      capellaData: capella_mev.SignedBlindedBeaconBlock(
        message: forked.capellaData, signature: signature
      ),
    )
  of ConsensusFork.Deneb:
    T(
      ...
      denebData: deneb_mev.SignedBlindedBeaconBlock(
        message: forked.denebData, signature: signature
      ),
    )

template init*(
    T: type ForkedMsgTrustedSignedBeaconBlock, blck: phase0.MsgTrustedSignedBeaconBlock
): T =
  T(kind: ConsensusFork.Phase0, phase0Data: blck)

template init*(
    T: type ForkedMsgTrustedSignedBeaconBlock, blck: altair.MsgTrustedSignedBeaconBlock
): T =
  T(kind: ConsensusFork.Altair, altairData: blck)

template init*(
    T: type ForkedMsgTrustedSignedBeaconBlock,
    blck: bellatrix.MsgTrustedSignedBeaconBlock,
): T =
  T(kind: ConsensusFork.Bellatrix, bellatrixData: blck)

template init*(
    T: type ForkedMsgTrustedSignedBeaconBlock, blck: capella.MsgTrustedSignedBeaconBlock
): T =
  T(kind: ConsensusFork.Capella, capellaData: blck)

template init*(
    T: type ForkedMsgTrustedSignedBeaconBlock, blck: deneb.MsgTrustedSignedBeaconBlock
): T =
  T(kind: ConsensusFork.Deneb, denebData: blck)
...
template forky*(
    x: ForkedBeaconBlock | ForkedHashedBeaconState, kind: static ConsensusFork
): untyped =
  when kind == ConsensusFork.Deneb:
    x.denebData
  elif kind == ConsensusFork.Capella:
...
template asSigned*(
    x: ForkedMsgTrustedSignedBeaconBlock | ForkedTrustedSignedBeaconBlock
): ForkedSignedBeaconBlock =
  isomorphicCast[ForkedSignedBeaconBlock](x)

template asSigned*(
    x: ref ForkedMsgTrustedSignedBeaconBlock | ref ForkedTrustedSignedBeaconBlock
...
template asTrusted*(
    x: ForkedSignedBeaconBlock | ForkedMsgTrustedSignedBeaconBlock
): ForkedTrustedSignedBeaconBlock =
  isomorphicCast[ForkedTrustedSignedBeaconBlock](x)

template asTrusted*(
    x: ref ForkedSignedBeaconBlock | ref ForkedMsgTrustedSignedBeaconBlock
): ref ForkedTrustedSignedBeaconBlock =
  isomorphicCast[ref ForkedTrustedSignedBeaconBlock](x)

template withBlck*(
    x:
      ForkedBeaconBlock | ForkedSignedBeaconBlock | ForkedMsgTrustedSignedBeaconBlock |
...
chronicles.formatIt ForkedSignedBeaconBlock:
  it.shortLog
chronicles.formatIt ForkedMsgTrustedSignedBeaconBlock:
  it.shortLog
...
func toBeaconBlockHeader*(
    blck:
      SomeForkyBeaconBlock | capella_mev.BlindedBeaconBlock |
...
template toBeaconBlockHeader*(
    blckParam: ForkedMsgTrustedSignedBeaconBlock | ForkedTrustedSignedBeaconBlock
): BeaconBlockHeader =
...
func toSignedBeaconBlockHeader*(
    signedBlock:
      SomeForkySignedBeaconBlock | capella_mev.SignedBlindedBeaconBlock |
      deneb_mev.SignedBlindedBeaconBlock
...
func readSszForkedHashedBeaconState*(
  ...
  let header =
    SSZ.decode(data.toOpenArray(0, sizeof(BeaconStateHeader) - 1), BeaconStateHeader)
...
func readSszForkedSignedBeaconBlock*(
  ...
  let header = SSZ.decode(
    data.toOpenArray(0, sizeof(ForkedBeaconBlockHeader) - 1), ForkedBeaconBlockHeader
  )
...
template init*(
  ...
  ForkedMaybeBlindedBeaconBlock(
    kind: ConsensusFork.Capella,
    capellaData: capella_mev.MaybeBlindedBeaconBlock(isBlinded: false, data: blck),
    consensusValue: cvalue,
    executionValue: evalue,
  )
...
template init*(
  ...
  ForkedMaybeBlindedBeaconBlock(
    kind: ConsensusFork.Capella,
    capellaData: capella_mev.MaybeBlindedBeaconBlock(isBlinded: true, blindedData: blck),
    consensusValue: cvalue,
    executionValue: evalue,
  )
...
template init*(
  ...
  ForkedMaybeBlindedBeaconBlock(
    kind: ConsensusFork.Deneb,
    denebData: deneb_mev.MaybeBlindedBeaconBlock(isBlinded: false, data: blck),
    consensusValue: cvalue,
    executionValue: evalue,
  )
...
template init*(
  ...
  ForkedMaybeBlindedBeaconBlock(
    kind: ConsensusFork.Deneb,
    denebData: deneb_mev.MaybeBlindedBeaconBlock(isBlinded: true, blindedData: blck),
    consensusValue: cvalue,
    executionValue: evalue,
  )
