...
type
  ...
  ForkedBlindedBeaconBlock* = object
    ...
    of ConsensusFork.Deneb:   denebData*:   BlindedBeaconBlock
  ...
  ForkedSignedBlindedBeaconBlock* = object
    ...
    of ConsensusFork.Deneb:   denebData*:   SignedBlindedBeaconBlock
...
# The purpose of this type is to unify the pre- and post-Deneb
...
template toSignedBeaconBlock*(b: ForkySignedBeaconBlockMaybeBlobs): ForkySignedBeaconBlock =
  when b is deneb.SignedBeaconBlockAndBlobsSidecar:
    b.beacon_block
  else:
    b
...
func init*(T: type ForkedSignedBlindedBeaconBlock,
  ...
  of ConsensusFork.Deneb:
    T(kind: ConsensusFork.Deneb,
      denebData: SignedBlindedBeaconBlock(message: forked.denebData,
                                            signature: signature))
