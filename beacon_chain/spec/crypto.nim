...
# https://github.com/ethereum/eth2.0-specs/blob/v0.2.0/specs/bls_signature.md#bls_aggregate_pubkeys
...
# https://github.com/ethereum/eth2.0-specs/blob/master/specs/bls_signature.md#bls_verify
func bls_verify*(
