...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/altair/light-client/full-node.md#block_to_light_client_header
...
# https://github.com/ethereum/consensus-specs/blob/v1.4.0-alpha.2/specs/capella/light-client/full-node.md#modified-block_to_light_client_header
