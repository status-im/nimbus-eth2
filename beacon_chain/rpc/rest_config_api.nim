    ...
    cachedConfigSpec =
      RestApiResponse.prepareJsonResponse(
        (
          ...
          # https://github.com/ethereum/consensus-specs/blob/v1.4.0-beta.7/presets/mainnet/altair.yaml
          ...
          # https://github.com/ethereum/consensus-specs/blob/v1.4.0-beta.7/presets/mainnet/bellatrix.yaml
          ...
          # https://github.com/ethereum/consensus-specs/blob/v1.4.0-beta.7/presets/mainnet/capella.yaml
          ...
          # https://github.com/ethereum/consensus-specs/blob/v1.4.0-beta.7/presets/mainnet/deneb.yaml
