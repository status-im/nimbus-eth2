    ...
    cachedConfigSpec =
      RestApiResponse.prepareJsonResponse(
        (
          ...
          # https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.8/presets/mainnet/altair.yaml
          ...
          # https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.8/presets/mainnet/bellatrix.yaml
          ...
          # https://github.com/ethereum/consensus-specs/blob/v1.5.0-alpha.8/presets/mainnet/capella.yaml
